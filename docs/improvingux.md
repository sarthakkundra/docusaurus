...
<video src="/img/textinput.mp4" muted={true} autoPlay={true} loop={true} width={320} height={430} />
...
<video src="/img/keyboardavoidingview.mp4" muted={true} autoPlay={true} loop={true} width={320} height={448} />
...
<video src="/img/hitslop.mp4" muted={true} autoPlay={true} loop={true} width={320} height={120} />
...
<video src="/img/ripple.mp4" muted={true} autoPlay={true} loop={true} width={320} />
