...
- `default` (the default), same as `black`. alex ignore retext-profanities
- `black`, scroll indicator is black. This style is good against a white content background. alex ignore retext-profanities
