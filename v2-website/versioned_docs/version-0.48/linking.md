...
You can use other URLs, like a location (e.g. "geo:37.484847,-122.148386" on Android or "http: on iOS), a contact, or any other URL that can be opened with the installed apps.
...
NOTE: As of iOS 9, your app needs to provide the `key inside` or canOpenURL will always return false.
...
NOTE: To support deep linking on Android, refer
