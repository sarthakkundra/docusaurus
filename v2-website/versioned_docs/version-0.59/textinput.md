...
* [``](textinput.md#importantForAutofill)
...
* [``](textinput.md#rejectrespondertermination)
...
If ``, allows TextInput to pass touch events to the parent component. This allows components such as SwipeableListView to be swipeable from the TextInput on iOS, as is the case on Android by default.
