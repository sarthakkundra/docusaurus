...
The problem exposing properties of native components is covered in detail in [this article](native-components-ios.md#properties). In short, export properties with `` macro in your custom native component, then use them in React Native as if the component was an ordinary React Native component.
...
This case is covered in [this article](native-components-ios.md#styles). To summarize, as all our native react views are subclasses of ``, most style and size attributes will work like you would expect out of the box.
