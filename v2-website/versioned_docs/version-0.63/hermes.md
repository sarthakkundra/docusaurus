...
<a href="https://hermesengine.dev">
  <img width={300} height={300} style={{cssFloat: "right", margin: "-30px 4px 0"}} src="/docs/assets/HermesLogo.svg" />
</a>
...
&gt; ## Note for Windows users. &gt; &gt; Hermes requires [Microsoft Visual C++ 2015 Redistributable](https://www.microsoft.com/en-us/download/details.aspx?id=48145)
...
&gt; ## Note about Android App Bundles &gt; &gt; Android app bundles are supported from react-native 0.62.0 and up.
